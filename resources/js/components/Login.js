                                            ...
                                            <center>
                                                ...
                                                <div className="col-lg-12 col-lg-offset-1 col-lg-offset-right-1 col-md-12 col-md-offset-1 col-md-offset-right-1 col-sm-12 col-xs-12 pull-right ">
                                                    <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                        <input className="mdl-textfield__input" type="text" placeholder="User Name" name="username" required id="username" name="username" value={this.state.username} onChange={this.onChange} autoComplete="off" />
                                                ...
                                                <div className="col-lg-12 col-lg-offset-1 col-lg-offset-right-1 col-md-12 col-md-offset-1 col-md-offset-right-1 col-sm-12 col-xs-12 pull-right " >
                                                    <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                        <input className="mdl-textfield__input" id="password" type="password" placeholder="Password" name="password" required id="password" value={this.state.password} onChange={this.onChange} autoComplete="off" />
